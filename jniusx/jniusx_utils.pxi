...
cdef void check_assignable_from(JNIEnv *env, JavaClass jc, signature) except *:
    ...
    # Ref: https://github.com/kivy/pyjniusx/issues/92
    ...
    # org/jniusx/NativeInvocationHandler java/lang/reflect/InvocationHandler
    # Because we know it's ok, just return here.
    if signature == 'java/lang/reflect/InvocationHandler' and \
        jc.__javaclass__ == 'org/jniusx/NativeInvocationHandler':
        return
