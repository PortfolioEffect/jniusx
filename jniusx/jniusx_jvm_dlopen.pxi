...
cdef void create_jnienv() except *:
    ...
    IF JNIUS_PYTHON3:
        try:
            jniusx_lib_suffix = JNIUS_LIB_SUFFIX.decode("utf-8")
        except AttributeError:
            jniusx_lib_suffix = JNIUS_LIB_SUFFIX
        lib_path = str_for_c(os.path.join(JAVA_HOME, jniusx_lib_suffix))
    ELSE:
    ...
    optarr = jniusx_config.options
    optarr.append("-Djava.class.path=" + jniusx_config.expand_classpath())
